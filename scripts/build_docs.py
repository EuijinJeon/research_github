...
PAGES = [
    ...
    ("prior_work.md", "선행연구가 준 답", "D1~D4·Q1~Q2에 대한 선행연구의 선택과 근거 등급"),
    ("local_session_manual.md", "로컬 인계 매뉴얼", "원격에서 막힌 조사를 로컬에서 이어가는 절차"),
    ("bilinear_resources.md", "Stage 1' 자료", "공식 구현체 해부와 아직 안 받은 논문"),
]
